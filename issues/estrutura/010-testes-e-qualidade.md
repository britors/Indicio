...
**Trilha:** Estrutura
**Estado:** Parcial
**Depende para encerramento de:** #009, #013, #014 e #018
...
- Criar uma travessia reutilizável que teste todos os caminhos de cada caso
  publicado até finais positivos.
...
- Manter testes arquiteturais para impedir dependências externas no domínio e
  na aplicação e impedir acesso de `ui/` a dados, composição ou navegação.
