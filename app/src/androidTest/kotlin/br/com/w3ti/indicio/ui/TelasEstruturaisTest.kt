...
import br.com.w3ti.indicio.application.catalogo.CasoDoCatalogo
import br.com.w3ti.indicio.application.catalogo.SituacaoCasoCatalogo
...
import br.com.w3ti.indicio.ui.catalogo.ConteudoCatalogo
import br.com.w3ti.indicio.ui.catalogo.EstadoCatalogo
import br.com.w3ti.indicio.ui.catalogo.GrupoDeCategoria
import br.com.w3ti.indicio.ui.catalogo.TAG_LISTA_CATALOGO
import br.com.w3ti.indicio.ui.configuracoes.ConteudoConfiguracoes
import br.com.w3ti.indicio.ui.historia.ConteudoConclusao
import br.com.w3ti.indicio.ui.historia.ConteudoHistoria
import br.com.w3ti.indicio.ui.historia.EstadoHistoria
import br.com.w3ti.indicio.ui.inicio.ConteudoInicio
import br.com.w3ti.indicio.ui.inicio.EstadoInicio
...
class TelasEstruturaisTest {
    ...
    private fun cenaComDuasEscolhas() = Cena(
        ...
        escolhas = listOf(
            br.com.w3ti.indicio.domain.model.caso.Escolha("a", "Primeira opção", "outra"),
            br.com.w3ti.indicio.domain.model.caso.Escolha("b", "Segunda opção", "outra"),
        ),
    )
